                ...
                if (this.vTaskList[i].getGroup()) {
                    ...
                    if (this.vTaskList[i].getStartVar()) {
                        if (this.vTaskList[i].getStartVar().getTime() < this.vTaskList[i].getPlanEnd().getTime()) {
                            var vTaskCompleteLeftPx = general_utils_1.getOffset(curTaskStart, this.vTaskList[i].getStartVar(), vColWidth, this.vFormat, this.vShowWeekends);
                            ...
                            var vTaskCompleteRightPx = general_utils_1.getOffset(this.vTaskList[i].getStartVar(), taskCompleteOnTimeDate, vColWidth, this.vFormat, this.vShowWeekends);
                            // textbar
                            vTmpDiv2 = draw_utils_1.newNode(vTmpDiv_1, 'div', this.vDivId + 'taskbar_' + vID, this.vTaskList[i].getClass(), null, vTaskCompleteRightPx, vTaskCompleteLeftPx);
                        ...
                        if (this.vTaskList[i].getDelayStart()) {
                            var delayWidth = general_utils_1.getOffset(this.vTaskList[i].getDelayStart(), this.vTaskList[i].getDelayEnd(), vColWidth, this.vFormat, this.vShowWeekends);
                            draw_utils_1.newNode(vTmpDiv_1, 'div', this.vDivId + 'delaybar_' + vID, 'delaybar', null, delayWidth);
                        }
                    }
                    // PLANNED
